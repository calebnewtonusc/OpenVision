...
/**
 * Floating spatial panel. Draggable from the header, closeable, glass styling,
 * indigo focus ring when `gazeFocused`. Tagged `data-gaze-target` so
 * `useDwellClick` will pick it up by default.
 */
